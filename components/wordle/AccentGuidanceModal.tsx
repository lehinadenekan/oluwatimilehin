...
interface AccentGuidanceModalProps {
  isOpen: boolean;
  onClose: () => void;
  guessWord?: string;
  solutionWord?: string;
...
const AccentGuidanceModal: React.FC<AccentGuidanceModalProps> = ({ 
  isOpen, 
  onClose,
  guessWord = '',
  solutionWord = '',
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      >
        ...
        <div className="flex justify-between items-center p-6 pb-4">
          <h2 className="text-2xl font-bold text-white">Àmì Ohùn (Tonal Marks)</h2>
          <button
            onClick={onClose}
...
export default AccentGuidanceModal; 